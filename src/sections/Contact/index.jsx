...
import "@renoeno/dsc-design-system-meiuca/dist/components/input";
import "@renoeno/dsc-design-system-meiuca/dist/components/select";
import "@renoeno/dsc-design-system-meiuca/dist/components/textarea";
import "@renoeno/dsc-design-system-meiuca/dist/components/button";
import iconShapes from "@renoeno/design-assets-meiuca/dist/assets/icons/shapes";
import "./style.scss";
    ...
    <div className="section-contact">
      ...
      <div className="section-contact__form">
        ...
        <div className="container grid grid-cols-12 gap-x-1 md:gap-x-2 lg:gap-x-3">
          <div className="col-start-7 md:col-start-4 col-span-6 section-contact__form--action">
            {loading ? (
              <dsc-button size="lg" loading>
                Button Primary
              </dsc-button>
            ) : (
              <dsc-button id="send-button" size="lg">
                Button Primary
              </dsc-button>
            )}
          </div>
      ...
      {showFeedback && (
        <div className="section-feedback">
          ...
          <dsc-typography component="paragraph">
            Deu tudo certo. Já já chega no seu inbox. Deve demorar uns
            minutinhos, tá?
          </dsc-typography>
          <XisSVG />
        </div>
